...
newTrial("Intro",
    ...
    .print()
    ,
    newText("Then you will let us know how literally interpretable you find it.")
    .css("font-size","1.8em")
    ,
    newText("<p>")
    .css("font-size","2em")
...
,
                ...
                .print()
,
            newText('<p><i>A rating of <b>1</b> would indicate that the expression does not have any possible literal interpretation.</i></p>')
            .center()
            .css("font-size","1.8em")
            .print()
,
            newText("<p><i>Intermediate values (<b>2, 3, 4</b>) should indicate the degree to which a literal interpretation is plausible.</i></p>")
            .center()
            .css("font-size","1.8em")
            .print()
,
            newText("<p><i>A rating of <b>5</b> would indicate that the expression definitely has a well-formed literal interpretation.</i></p>")
            .center()
            .css("font-size","1.8em")
            .print()
,
...
,
            ...
            .css("font-size","1.4em")
                ...
                .print()
,
newTooltip("guide", "<p>Carefully read the expression and give a rating for how literally interpretable you find it. Use the full range of the scale to make your judgment.</p> <p><b>**After the next two expressions, the instructions will be removed so you can focus on the task.**</b></p>")
        .css("font-size","1.2em")
...
,
            ...
            .css("font-size","1.4em")
                ...
                .print()
,
newTooltip("guide", "Carefully read the expression and give a rating for how literally interpretable you find it.")
        .css("font-size","1.5em")
        .position("top center")  // Display it below the element it attaches to
        .key("", "no click")        // Prevent from closing the tooltip (no key, no click)
        .print(getText("target"))   // Attach to the "target" Text element
