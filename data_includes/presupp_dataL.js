...
newTrial("Intro",
    defaultText.center().print()
    ,
    newText("<p>Hello! Welcome to our <i>How likely is it that...?</i> task!</p>")
    .css("font-size","1.8em")
        .bold()
    ,
    ...
    .print()
    ,
    newText("You will then be asked a follow-up question that begins with <i>How likely is it that...?</i>")
    .css("font-size","1.8em")
    ,
    newText("<p>")
    .css("font-size","2em")
...
newTrial("Intro2",
    defaultText.center().print()
,
            newText("<p>Your job will be to read a sentence carefully. Then you will receive a follow-up question where you will select a likelihood rating from <b>1</b> <i>(least likely)</i> to <b>5</b> <i>(most likely)</i> for your response.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
            newText("<p>For example, you will be shown the sentence, <i>When Alma left town, she made sure to cover her tracks</i>. Then you will be given a follow-up question such as, <b>How likely is it that she was hiding something?</b> If you think, based on the initial sentence, that it is likely that she is hiding something, you should choose a higher number on the scale. In other words, selecting a <b>4</b> or <b>5</b> means that the sentence provides you with evidence to consider it likely that <b>she was hiding something</b>.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
            newText("<p>Otherwise, you can respond with a lower number. Selecting <b>1</b> or <b>2</b> means that you don’t think the sentence provides you with much evidence. You will see that some sentences provide clearer evidence for answering the follow-up question than others.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
...
Template( "BanalP.txt", row =>
    ...
    .css("font-size","1.4em")
                ...
                .print()
    ,
newTooltip("guide", "<p>Carefully read the sentence and answer the question below. Select a likelihood rating from <b>1</b> <i>(least likely)</i> to <b>5</b> <i>(most likely)</i> for your response. </p><p><b>**After the next two sentences, the instructions will be removed so you can focus on the task.**</b></p>")
...
Template( "BanalP2.txt", row =>
    ...
    .css("font-size","1.4em")
                ...
                .print()
    ,
newTooltip("guide", "<p>Carefully read the sentence and answer the question below. Select a likelihood rating from <b>1</b> <i>(least likely)</i> to <b>5</b> <i>(most likely)</i> for your response.</p>")
        .position("top center")  // Display it below the element it attaches to
        .css("font-size","1.2em")
        .key("", "no click")        // Prevent from closing the tooltip (no key, no click)
        .print(getText("target"))   // Attach to the "target" Text element
