...
newTrial("Intro2",
    defaultText.center().print()
,
            newText("<p>Your job will be to read a sentence carefully. Then you will determine whether the follow-up question ought to get a <b>Yes</b> or <b>No</b> response.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
            newText("<p>For example, you will be shown the sentence, <i>When Alma left town, she made sure to cover her tracks</i>. Then you will be given a follow-up question such as, <b>Is it likely she was hiding something?</b> If you think, based on the initial sentence, that it is likely that she is hiding something, you should respond <b>Yes</b>. In other words, selecting <b>Yes</b> means that the sentence provides you with evidence to consider it likely that <b>she was hiding something</b>.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
            newText("<p>Otherwise, you can respond <b>No</b>. Selecting <b>No</b> means that you don’t think the sentence provides you with such evidence. You will see that some sentences provide clearer evidence for answering the follow-up question than others.</p>")
            .left()
            .css("font-size","1.8em")
            .print()
,
...
Template( "BanalP.txt", row =>
    ...
    .css("font-size","1.4em")
                ...
                .print()
    ,
newTooltip("guide", "<p>Carefully read the sentence and answer the question below. Select <b>Yes</b> or <b>No</b> to make your judgment.</p><p><b>**After the next two sentences, the instructions will be removed so you can focus on the task.**</b></p>")
...
Template( "BanalP2.txt", row =>
    ...
    .css("font-size","1.4em")
                ...
                .print()
    ,
newTooltip("guide", "<p>Carefully read the sentence and answer the question below. Select <b>Yes</b> or <b>No</b> to make your judgment.</p>")
        .position("top center")  // Display it below the element it attaches to
        .css("font-size","1.2em")
        .key("", "no click")        // Prevent from closing the tooltip (no key, no click)
        .print(getText("target"))   // Attach to the "target" Text element
